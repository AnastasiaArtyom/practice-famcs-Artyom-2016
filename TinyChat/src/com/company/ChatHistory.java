...
public class ChatHistory {
    ...
    private TreeSet<HistoryItem> chat = new TreeSet(new Comparator<HistoryItem> (){
        @Override
        public int compare(HistoryItem first, HistoryItem second){
            return first.getId().compareTo(second.getId());
        }
    });
    private int numItems, numItemsAdded, numItemsDeleted;
    ...
    private ArrayList<HistoryItem> getAllItemsAsArrayList(){
        ...
        chatList.ensureCapacity(numItems);
        for(HistoryItem item : chat) {
            chatList.add(item);
        }
        return chatList;
    ...
    private ArrayList<HistoryItem> getFilteredBy(Predicate predicate){
        ArrayList<HistoryItem> chatList = new ArrayList<HistoryItem>();
        for(HistoryItem item : chat){
