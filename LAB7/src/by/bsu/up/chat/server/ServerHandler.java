...
public class ServerHandler implements HttpHandler {
    ...
    public ServerHandler() {
        //System.out.println("Hello, serverHandler");
        messageStorage = new InMemoryMessageStorage();
        try {
            loggerFile = new LogFile("serverLog.txt");
    ...
    private Response dispatch(HttpExchange httpExchange) {
        //System.out.println("Hello dispatch");
        loggerFile.info("method: " + httpExchange.getRequestMethod());
